<template>
  <ConfigureWalletCard>
    <div class="sm:flex items-stretch sm:space-y-0 sm:space-x-10 space-y-4">
      <div
        class="p-4 border-2 border-blue-500 rounded-lg hover:bg-blue-500 hover:text-white"
        @click="$router.push({ path: '/configure-wallet/create' })"
      >
      ...
      <div
        class="p-4 border-2 border-blue-500 rounded-lg hover:bg-blue-500 hover:text-white parent"
        @click="$router.push({ path: '/configure-wallet/import' })"
      >
        <div class="flex flex-col ">
